...
[x] Add skill to create a new Stripe product for a new show. Ask the user which previous product they want to use as a refernce to copy, and from there ask the user what adjustments need to be made: including location, date, time, name of the show. With this info generate the product name. Ask also for the price, and force the user to explicitly set the currency too, as she performs both in Serbia and abroad.
